...
# It is the dictionary that has the data : { label(positive/negative) : { word : count of number of occurences of the
#  word } }
dataset = {}
...
for row in reader:
    ...
    for i in split_data:
        ...
        if len(i) > 2:
            ...
            # If the label was found for the word, for the first time, initialize corresponding count value for word
            # as key
